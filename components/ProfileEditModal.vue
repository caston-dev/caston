    ...
    <div class="modal-card" style="max-width: 400px; margin: 0 auto;">
        ...
        <div class="modal-card-body">
            ...
            >
                ...
                ></b-input>
                <div class="buttons">
                    <a class="button is-light" @click.prevent="openItemEditModal('career')">追加する</a>
                </div>
            </b-field>
            ...
            >
                ...
                ></b-input>
                <div class="buttons">
                    <a class="button is-light" @click="openItemEditModal('appearance')">追加する</a>
                </div>
            </b-field>
            ...
            >
                ...
                ></b-input>
                <div class="buttons">
                    <a class="button is-light" @click="openItemEditModal('certification')">追加する</a>
                </div>
            </b-field>
            ...
            >
                ...
                ></b-input>
                <div class="buttons">
                    <a class="button is-light" @click.prevent="openItemEditModal('favorite')">追加する</a>
                </div>
            </b-field>
